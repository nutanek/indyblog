<?php
	...
	function theme_styles() {
		...
		wp_enqueue_style( 'theme-css', get_template_directory_uri() . '/css/theme-style.css');
		//include JS file
		...
		wp_enqueue_script( 'scrollreveal-js', get_template_directory_uri() . '/js/scrollreveal.min.js');
	}
